        ...
        <>
            <div className="right-content w-100">
                ...
                <form className='form' onSubmit={addHomeSlide}>
                    <div className='row'>
                        <div className='card-big col-sm-9'>
                            <div className='card card p-4 mt-0'>

                                <div className="imagesUploadSec">
                                    <h5 className="mb-4">Media And Published</h5>

                                    <div className='imgUploadBox d-flex align-items-center justify-content-start flex-row'>
                                    ...
                                    <Button type="submit" className="btn-blue-big w-100"
